...
export class App extends Component {
  ...
  render() {
    // const map =  window.location.pathname === '/walk/new' ? <Map/> : null
    ...
    <div> 
      ...
      <BrowserRouter>
            <Switch>
              ...
              {/* <Route path="/map/new" render={(routerProps) => <Map {...routerProps}/>} /> */}
              <Route path="/route" render={(routerProps) => <Walk {...routerProps}/>} />
              <Route path="/walkers" render={(routerProps) => <WalkerList {...routerProps}/>} />
              <Route exact path="/" render={(routerProps) => <Landing {...routerProps}/>} />
              <Route exact path = '/walk/new'render={(routerProps) => <Map 
